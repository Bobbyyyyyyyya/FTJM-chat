 ...
 */
export { supabase };
export declare function checkCanAccessConversation(conversationId: string, userId: string): Promise<any>;
export declare function checkCanEditProfile(userId: string, currentUserId: string): Promise<boolean>;
export declare function checkCanEditPost(postId: string, currentUserId: string): Promise<boolean>;
export declare function checkCanSendMessage(conversationId: string, userId: string): Promise<any>;
