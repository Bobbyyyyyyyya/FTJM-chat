...
export async function checkCanAccessConversation(conversationId, userId) {
    try {
...
export async function checkCanEditProfile(userId, currentUserId) {
    return userId === currentUserId;
}
export async function checkCanEditPost(postId, currentUserId) {
    try {
        const { data } = await supabase
            .from('posts')
            .select('author_id')
...
export async function checkCanSendMessage(conversationId, userId) {
